...
///////////////RedFirePiranhaAnimationFactory////////
RedFirePiranhaAnimationFactory::RedFirePiranhaAnimationFactory(FirePiranha* piranha, Mario* mario){
	if (mario != NULL){
		mMario = mario;
	}
	else{
...
Animation* RedFirePiranhaAnimationFactory::createAnimation(){
	Animation* result = 0;
	if (mMario == NULL){
		mMario = ObjectManager::getInstance()->getMario();
	}
